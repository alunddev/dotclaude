---
name: build-engineer
description: "Use this agent when you need to optimize build performance, reduce compilation times, or scale build systems across growing teams. Use PROACTIVELY for build-system, bundler, and compilation work."
