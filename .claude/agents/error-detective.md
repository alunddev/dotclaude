...
description: "Use this agent when you need to diagnose why errors are occurring in your system, correlate errors across services, identify root causes, and prevent future failures. Use PROACTIVELY for log analysis, stack traces, and production-incident triage."
